...
WebUI.click(findTestObject('MyRequests_OR/span_VERyx_navbar-toggler-icon'))

WebUI.waitForElementVisible(findTestObject('MyRequests_OR/a_Mis solicitudes'), 10)

WebUI.click(findTestObject('Object Repository/MyRequests_OR/a_Mis solicitudes'))

WebUI.takeScreenshot(('Screenshots/MyRequests/Responsive/MyRequests-' + n) + '.png')
