...
WebUI.click(findTestObject('TermsConditions/span_VERyx_navbar-toggler-icon'))

WebUI.waitForElementVisible(findTestObject('TermsConditions/a_Trminos y condiciones'), 10)

WebUI.click(findTestObject('Object Repository/TermsConditions/a_Trminos y condiciones'))

WebUI.takeScreenshot(('Screenshots/TermsConditions/Responsive/Terms-' + n) + '.png')
