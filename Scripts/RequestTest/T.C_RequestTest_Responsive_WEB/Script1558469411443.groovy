...
WebUI.click(findTestObject('RequestTest_OR/span_VERyx_navbar-toggler-icon'))

WebUI.waitForElementVisible(findTestObject('RequestTest_OR/a_Solicitar prueba'), 10)

WebUI.click(findTestObject('RequestTest_OR/a_Solicitar prueba'))

WebUI.click(findTestObject('RequestTest_OR/a_01'))

WebUI.takeScreenshot(('Screenshots/RequestTest/Responsive/RequestTest-' + n) + '.png')
